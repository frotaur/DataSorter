...
v_trainer = VideoRewardTrainer(model, lr_body=0., no_logging=False, data_loc='clipvip_data', run_name_extra='b20coolnowarm',device='cuda:2')
...
v_trainer.train_model(steps=1000,batch_size=20)
