...
class MainWindow(Tk):
    ...
    """
    def __init__(self, reward_trainer=None, live_training=False, **kwargs):
        """
            Args:
        ...
        self.picframe= ViewFrame(upframe,self.raw_imgfold,self.datapath, reward_trainer=reward_trainer, live_training=live_training)
